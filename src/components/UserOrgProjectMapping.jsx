...
//       </h2> */}
//       <div className="p-4 border-b border-gray-100 mb-1 flex items-center justify-between bg-gray-50/50">
...
//               ? "bg-[#17414d] text-white  shadow   border border-blue-300"
...
//               ? " shadow bg-[#17414d] text-white group-hover:text-gray border border-blue-300"
//               : "text-gray-700 hover:bg-gray-200"
//           }`}
    ...
    <div className="p-6 w-full mx-auto bg-white rounded-2xl shadow">
      ...
      <div className="flex mb-6 bg-gray-100 rounded-lg p-1">
        <button
          className={`flex-1 py-2 px-4 text-sm font-medium rounded ${
            activeMainTab === "projectUsers"
              ? " shadow bg-[#17414d] text-white group-hover:text-gray border border-blue-3000"
              : "text-gray-700 hover:bg-gray-200"
          }`}
          onClick={() => setActiveMainTab("projectUsers")}
        >
