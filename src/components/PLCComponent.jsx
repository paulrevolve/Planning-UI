...
const PLCComponent = ({ selectedProjectId, selectedPlan, showPLC }) => {
  ...
  return (
    <div className=" rounded-xl border m-2 border-gray-200  p-2 sm:p-4 min-h-[150px] scroll-mt-16 text-xs">
      {/* <ToastContainer
        position="top-right"
        autoClose={3000}
        ...
        <div className="overflow-x-auto rounded-sm overflow-y-auto max-h-64 border border-gray-200">
          <table className="w-full text-sm border-collapse ">
            ...
            <tbody>
              ...
              ) : billingRatesSchedule.length === 0 && !newEmployeeRate ? (
                <tr>
                  <td
                    colSpan="9"
        ...
        <div className="overflow-x-auto overflow-y-auto max-h-64 rounded-sm border border-gray-200">
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              ...
              ) : vendorBillingRates.length === 0 && !newEmployeeRate ? (
                <tr>
                  <td
                    colSpan="9"
                    className="px-3 py-4 text-center text-gray-500"
