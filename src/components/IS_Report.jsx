...
//                 </div>
//                 <p className="text-lg font-sans font-medium">Click "Run Report" to load  data</p>
...
const IS_Report = () => {
  ...
  const handleExportPPT = () => {
    ...
    slide.addText([{ text: "SUMARIA SYSTEMS, LLC  ", options: { bold: true, fontSize: 13, color: "333333" } }, { text: "|  Income Statement", options: { italic: true, fontSize: 13, color: "1d4ed8" } }], { x: 0.5, y: 0.15, w: 12.3, align: "center" });
        ...
        {hasRun && !loading && calculations ? (
          <div className="w-full">
            <header className="text-center mb-20">
              <h1 className="text-[42px] font-extralight uppercase tracking-[0.8em] text-slate-900">Sumaria Systems, LLC</h1>
          ...
          <div className="h-[60vh] flex flex-col items-center justify-center text-slate-300">
            <p className="text-3xl font-extralight uppercase tracking-[0.5em] text-blue-200">{loading ? 'Sumaria Systems, LLC' : 'Sumaria Systems, LLC'}</p>
          </div>
        )}
      </div>
    </div>
